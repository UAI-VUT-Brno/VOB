// VOB - Exercise 2, block 5
// A working PvZ-style game written procedurally, on purpose.
// One form class holds the whole world: state, rules, input and drawing.
//
// Controls:
// - Left click on a cell to place the selected plant.
// - Keys: 1 = PeaShooter, 2 = Sunflower, 3 = Wallnut, 4 = Bomb
// - Space = fast forward (2x), R = restart
//
// Rules (simplified):
...
namespace PvZLikeDemo
{
    ...
    public sealed class GameForm : Form
    {
        ...
        private void DrawUI(Graphics g)
        {
            ...
            // info
            g.DrawString($"Sun: {G.Sun}", font, Brushes.Gold, panelX, panelY);
            g.DrawString($"Wave: {G.Wave}", font, Brushes.White, panelX, panelY + 22);
